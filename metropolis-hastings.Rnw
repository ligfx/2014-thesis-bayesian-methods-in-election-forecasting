...
\noindent\textbf{Example:} Consider the distribution, \[
...
<<mixing, dev='tikz', fig.cap='Poorly-mixing and well-mixing Metropolis chains', out.width='.49\\linewidth', echo=FALSE, cache=TRUE, fig.show='hold'>>=
# Poorly-mixing
set.seed(47)
